    ...
    return (
      <div className="min-h-screen bg-charcoal-900 flex items-center justify-center p-4">
        <div className="bg-charcoal-800 p-8 rounded-2xl border border-white/10 w-full max-w-md shadow-2xl">
          ...
          <form onSubmit={(e) => {
            e.preventDefault();
            if(!login(email)) setMessage("Unauthorized email address.");
          }}>
            <div className="space-y-4">
              <div>
                <label className="block text-xs uppercase tracking-widest text-white/50 mb-2 font-bold">Email Address</label>
                <input 
                  type="email" 
                  value={email}
              ...
              <button className="w-full bg-brand-400 text-black font-bold uppercase tracking-widest py-3 rounded-xl hover:bg-brand-500 transition-colors">
                Access Portal
              </button>
            </div>
          </form>
